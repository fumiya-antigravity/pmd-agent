...
## JSON出力
{
  ...
  "aspectUpdates": {
    "[観点キー]": {"status": "ok|thin|empty", "text": "要約", "quoted": "原文引用", "reason": "分析理由", "advice": "アドバイス", "example": "記述例"}
  },
  "crossCheck": {
...
## JSON出力
{
  ...
  "aspectUpdate": {"aspect": "観点キー", "status": "ok|thin|empty", "text": "累積要約", "quoted": "原文引用", "reason": "分析理由", "advice": "アドバイス", "example": "記述例"},
  "relatedUpdates": [
    {"aspect": "観点キー", "relevanceScore": 0.0-1.0, "action": "append|overwrite|skip", "reason": "更新理由", "newText": "更新後の全文", "newStatus": "ok|thin", "advice": "アドバイス", "example": "記述例", "contradictionCheck": "矛盾有無"}
  ],
